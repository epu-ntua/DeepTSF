...
NOTE: this file is a copy of oauth2proxy/offline_store.py (the two containers
are built from different images and cannot share a module). Keep them in sync —
