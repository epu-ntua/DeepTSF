...
import sys
sys.path.append('..')
from .utils_ds import multiple_dfs_to_ts_file
...
def filtering(covariates, past_covs, future_covs, savgol_window_length, savgol_polyorder):
    ...
    for i, covariate in enumerate(covariates):
        covariate_array = savgol_filter(x=covariattopd_dataframe()["Value"], window_length=savgol_window_length, polyorder=savgol_polyorder)
